...
STOCKS_ID = [
    {"ticker":"BBCA","name":"Bank Central Asia","sector":"Banking","price_idr":10100,"change_pct":0.5,"rec":"BUY","rationale":"Bank swasta ROE tertinggi di Indonesia, NPL rendah, ekspansi digital banking solid.",
    ...
    {"ticker":"BBNI","name":"Bank BNI","sector":"Banking","price_idr":4890,"change_pct":0.8,"rec":"BUY","rationale":"Transformasi digital BNI berhasil, ROE meningkat, valuasi masih discount vs BBCA.",
     "dividend":{"yield_pct":5.1,"cum_date":"2026-04-05","ex_date":"2026-04-06","payment_date":"2026-04-28","freq":"Annual","note":"Dividend payout ratio ~45% dari laba"}},
    ...
    {"ticker":"ASII","name":"Astra International","sector":"Conglomerate","price_idr":5025,"change_pct":1.1,"rec":"BUY","rationale":"Diversifikasi otomotif, perkebunan, infrastruktur. Cyclical play dengan dividen stabil.",
    ...
    {"ticker":"ITMG","name":"Indo Tambangraya Megah","sector":"Coal Mining","price_idr":27800,"change_pct":1.3,"rec":"BUY","rationale":"Dividend yield tertinggi di IDX, balance sheet sangat kuat, cash cow batubara thermal.",
    ...
    {"ticker":"PTBA","name":"Bukit Asam","sector":"Coal Mining","price_idr":3180,"change_pct":0.9,"rec":"BUY","rationale":"BUMN batubara, dividend yield sangat tinggi, harga batubara global masih supportive.",
    ...
    {"ticker":"ADRO","name":"Adaro Energy Indonesia","sector":"Coal Mining","price_idr":2180,"change_pct":1.5,"rec":"BUY","rationale":"Diversifikasi ke green energy via AADI, batubara thermal masih cashflow kuat.",
    ...
    {"ticker":"ANTM","name":"Aneka Tambang","sector":"Mining (Gold/Nickel)","price_idr":1635,"change_pct":2.0,"rec":"BUY","rationale":"Beneficiary nikel EV + emas global. Harga emas di level tertinggi historis support valuasi.",
    ...
    {"ticker":"PGEO","name":"Pertamina Geothermal Energy","sector":"Renewable Energy","price_idr":1425,"change_pct":0.6,"rec":"BUY","rationale":"Pure-play geothermal terbesar di dunia, ESG premium, tarif jual listrik terjamin kontrak panjang.",
     "dividend":{"yield_pct":5.2,"cum_date":"2026-06-10","ex_date":"2026-06-11","payment_date":"2026-07-01","freq":"Annual","note":"Bisnis stabil dengan kontrak offtake PLN jangka panjang"}},
    {"ticker":"PGAS","name":"Perusahaan Gas Negara","sector":"Energy Infrastructure","price_idr":1580,"change_pct":-0.4,"rec":"HOLD","rationale":"Monopoli distribusi gas, arus kas stabil, dividend konsisten, tapi growth terbatas.",
    ...
    {"ticker":"BNGA","name":"Bank CIMB Niaga","sector":"Banking","price_idr":1245,"change_pct":0.3,"rec":"BUY","rationale":"Valuasi P/BV sangat murah dibanding peers, profitabilitas membaik, digital banking tumbuh.",
    ...
    {"ticker":"GOTO","name":"GoTo Gojek Tokopedia","sector":"Tech","price_idr":86,"change_pct":-1.2,"rec":"SPECULATIVE BUY","rationale":"Path to profitability mulai jelas, fintech tumbuh. Volatile, sizing matters.",
     "dividend":None},
    {"ticker":"UNVR","name":"Unilever Indonesia","sector":"Consumer","price_idr":1810,"change_pct":-0.5,"rec":"HOLD","rationale":"Brand kuat, dividend yield tinggi, tapi volume sales menurun dan persaingan meningkat.",
    ...
    {"ticker":"ICBP","name":"Indofood CBP","sector":"Consumer Staples","price_idr":11400,"change_pct":0.7,"rec":"BUY","rationale":"Defensive + ekspansi global Indomie. EM consumer play yang stabil dan konsisten.",
     "dividend":{"yield_pct":2.9,"cum_date":"2026-05-25","ex_date":"2026-05-26","payment_date":"2026-06-15","freq":"Annual","note":"Indomie hadir di 100+ negara, diversifikasi revenue"}},
]
